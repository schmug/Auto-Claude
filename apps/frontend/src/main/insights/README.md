...
- Manages Python and auto-sleuth source path configuration
- Detects auto-sleuth installation automatically
- Loads environment variables from auto-sleuth .env file
