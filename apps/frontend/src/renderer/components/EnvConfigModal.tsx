...
export function EnvConfigModal({
  ...
  description = 'A Claude Code OAuth token is required to use AI capabilities like Ideation and Roadmap generation.',
  projectId
}: EnvConfigModalProps) {
  ...
  const handleUseExistingProfile = async () => {
    ...
    try {
      ...
      // Save the token to auto-sleuth .env
            ...
            <div className="rounded-lg bg-success/10 border border-success/30 p-4 flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-success/80 mt-1">
                  You can now use AI capabilities like Ideation and Roadmap generation.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="space-y-3 pl-4 border-l-2 border-border">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      <code className="px-1 py-0.5 bg-muted rounded font-mono">
                        {sourcePath ? `${sourcePath}/.env` : 'auto-sleuth/.env'}
                      </code>
                    </p>
                  </div>
                </div>
