...
export function App() {
  ...
  // GitHub setup state (shown after Auto Sleuth init)
  ...
  // Check if selected project needs initialization (e.g., .auto-sleuth folder was deleted)
  useEffect(() => {
  ...
  return (
    <ViewStateProvider>
      ...
      <div className="flex h-screen bg-background">
        ...
        {/* GitHub Setup Modal - shows after Auto Sleuth init to configure GitHub */}
        {gitHubSetupProject && (
          <GitHubSetupModal
