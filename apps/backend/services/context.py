...
Usage:
    # Generate for a caseific service
    python auto-sleuth/service_context.py --service backend --output backend/SERVICE_CONTEXT.md

    # Generate for all services (using project index)
    python auto-sleuth/service_context.py --all

    # Generate with custom project index
    python auto-sleuth/service_context.py --service frontend --index auto-sleuth/project_index.json
"""
...
class ServiceContextGenerator:
    ...
    def generate_for_service(self, service_name: str) -> ServiceContext:
        """Generate context for a caseific service."""
    ...
    def generate_markdown(self, context: ServiceContext) -> str:
        ...
        lines.extend(
            [
                ...
                "*Update manually if you need to add service-caseific patterns or notes.*",
            ]
        )
...
def main():
    ...
    # Load project index if caseified
    project_index = None
