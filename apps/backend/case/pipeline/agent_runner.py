...
Handles the execution of AI agents for the case creation pipeline.
"""
...
class AgentRunner:
    ...
    async def run_agent(
        ...
        """
        debug_section("agent_runner", f"Case Agent - {prompt_file}")
        debug(
            "agent_runner",
            "Running case creation agent",
    ...
    def _get_tool_detail_content(tool_name: str, result_content: str) -> str | None:
        """Get detail content for caseific tools.
