...
def gather_phase_outputs(case_dir: Path, phase_name: str) -> str:
    """
    ...
    # Note: DFIR workflows use case.md instead of case.md
    phase_outputs: dict[str, list[str]] = {
        "discovery": ["context.json"],
        "requirements": ["requirements.json"],
        "research": ["research.json"],
        "context": ["context.json"],
        "quick_case": ["case.md", "case.md"],  # Check both
        "case_writing": ["case.md", "case.md"],  # Check both
        "self_critique": ["case.md", "case.md", "critique_notes.md"],  # Check both
        "planning": ["investigation_plan.json"],
        "validation": [],  # No output files to summarize
        "evidence_preprocessing": ["evidence_index.json"],  # DFIR phase
    }
