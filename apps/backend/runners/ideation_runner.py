...
Usage:
    python auto-sleuth/ideation_runner.py --project /path/to/project
    python auto-sleuth/ideation_runner.py --project /path/to/project --types low_hanging_fruit,high_value_features
    python auto-sleuth/ideation_runner.py --project /path/to/project --refresh
"""
...
def main():
    ...
    parser.add_argument(
        "--output",
        type=Path,
        help="Output directory for ideation files (default: project/auto-sleuth/ideation)",
    )
    parser.add_argument(
        "--types",
        type=str,
