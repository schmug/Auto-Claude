...
- Issue Auto-Fix: Automatic case creation and execution

This is a STANDALONE system - does not modify existing task execution pipeline.

REFACTORED: Service layer architecture - orchestrator delegates to caseialized services.
"""
...
class GitHubOrchestrator:
    ...
    This is a thin coordinator that delegates to caseialized service classes:
    ...
    def __init__(
        ...
        self.github_dir = self.project_dir / ".auto-sleuth" / "github"
    ...
    def _generate_enhanced_summary(
        ...
        lines.append("---")
        lines.append("_Generated by Auto Sleuth PR Review_")
    ...
    async def triage_issues(
        ...
        Args:
            issue_numbers: Caseific issues to triage, or None for all open issues
    ...
    async def auto_fix_issue(
        ...
        """
        Automatically fix an issue by creating a case and running the build pipeline.
    ...
    async def batch_and_fix_issues(
        ...
        Args:
            issue_numbers: Caseific issues to batch, or None for all open issues
    ...
    async def analyze_issues_preview(
        ...
        Args:
            issue_numbers: Caseific issues to analyze, or None for all open issues
